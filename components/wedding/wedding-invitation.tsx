...
const { timeline, gallery } = weddingContent;
      ...
      /> */}
          <div className="w-full text-black">
            ...
            <SectionScrollSnap snapUpToId="invite-hero">
              ...
              >
                ...
                >
                  ...
                  <br />
                  Khi {guest.titleLow} đang đọc những dòng này, cũng là lúc ngày
                  trọng đại của {guest.selfLow} đang đến rất gần. Sự hiện diện
                  của {guest.titleLow} trong khoảnh khắc ấy không chỉ là niềm
                  vui, mà còn là một phần ý nghĩa đặc biệt mà {guest.selfLow}{" "}
                  luôn trân trọng.
                  <br />
                  Trước khi cùng nhau bước vào ngày hạnh phúc đó,{" "}
                  {guest.selfLow} muốn mời {guest.titleLow} cùng “du hành thời
                  gian” một chút — quay lại hành trình 10 năm bên nhau của{" "}
                  {guest.selfLow} nhé....
                  <br />
              ...
              {guest.selfLow}. */}
                  {guest.grateful != null && guest.grateful !== "" ? (
                    <>
                      ...
                      <br />
                      <span>
                        Một lần nữa, {guest.selfLow} xin kính mời{" "}
                        {guest.titleLow} {guest.name} - {guest.grateful}.
                      </span>
                    </>
                  ) : null}
                </div>
                ...
                {guest.personal !== false ? (
                  <>
                    <p className="text-center" data-wedding-reveal>
                      {guest.title} {guest.name} thân mến, {guest.titleLow} sẽ
                      đến chung vui cùng {guest.selfLow} chứ ạ.
                    </p>
            ...
            >
              ...
              >
                <p className="mb-2 text-center" data-wedding-reveal>
                  {guest.title} có lời nào muốn tặng {guest.selfLow} không. Viết
                  vào đây nè!!!
                </p>
            ...
            >
              ...
              niềm vinh hạnh lớn đối với {guest.selfLow}. Thank you very muchh💖💖
              <br />
              <br />
              <br />
            </div>
